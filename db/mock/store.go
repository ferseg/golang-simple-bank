...
// Source: github.com/ferseg/golang-simple-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetUserSession(arg0 context.Context, arg1 string) (db.Session, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListUserAccounts(arg0 context.Context, arg1 db.ListUserAccountsParams) ([]db.Account, error) {
	m.ctrl.T.Helper()
